...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, { alignItems: "center" },
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "10px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
...
var TechRateAudit = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 369 120" }, props),
        React.createElement("image", { width: "369", height: "120", href: isDark ? '/images/egg/TechRateAuditDark.png' : '/images/egg/TechRateAuditWhite.png' })));
};
...
var AuditButton = function (_a) {
    ...
    return (React.createElement(StyledAudit, null,
        React.createElement("a", { href: auditLink, "aria-label": "AuditLink", target: "_blank" },
            React.createElement(TechRateAudit, { isDark: isDark }))));
};
var templateObject_1$D;
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React.createElement(AuditButton, { isDark: isDark, auditLink: auditLink }),
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, auditLink: (_c = auditLink === null || auditLink === void 0 ? void 0 : auditLink.href) !== null && _c !== void 0 ? _c : '/', toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#00d06a", textDisabled: "#BDC2C4", textSubtle: "#004705", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
