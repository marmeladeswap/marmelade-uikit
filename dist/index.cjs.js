...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" },
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "10px" }, isPushed ? (React__default['default'].createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
...
var AuditButton = function (_a) {
    ...
    return (React__default['default'].createElement(StyledAudit, null,
        React__default['default'].createElement("a", { href: auditLink, "aria-label": "AuditLink", target: "_blank" },
            React__default['default'].createElement(TechRateAudit, { isDark: isDark }))));
};
var templateObject_1$D;
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React__default['default'].createElement(AuditButton, { isDark: isDark, auditLink: auditLink }),
